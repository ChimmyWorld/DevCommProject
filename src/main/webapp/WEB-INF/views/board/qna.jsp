...
<body>
    ...
    <div>
        <h1 class="title1">Q&A<img class="title1img" src="${cpath }/assetImg/board2.png"></h1>
        </div>

        <div class="write">
            <button class="board-btn board-btn-blue" type="button" onclick="location.href='${cpath }/qna/new';" style="cursor: pointer;">
                작성하기
            </button>
            <form action="">
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="${cpath }/qna?order=idx">최신순</a>
                    <a href="${cpath }/qna?order=view_count">조회순</a>
                    <a href="${cpath }/qna?order=reply_count">댓글순</a>
                    <a href="${cpath }/qna?order=recommend_score">추천순</a>
                </div>
              </div>
            </form>
        </div>
        ...
        <div class="contents"><a href="${cpath }/qna/${row.idx }">
        ${row.title }
        </a></div>
        <th>
